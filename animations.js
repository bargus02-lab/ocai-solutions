...
(function () {
  ...
  function initAurora() {
    ...
    // Finalist ember palette — sunset coral on warm carbon, with a cream wash.
    var blobs = [
      { x: 0.18, y: 0.20, r: 0.55, color: 'rgba(255,106,77,0.55)',  sx: 0.00018, sy: 0.00013 },  // coral
      { x: 0.80, y: 0.30, r: 0.50, color: 'rgba(255,106,77,0.48)',  sx: -0.00022, sy: 0.00018 }, // coral
      { x: 0.55, y: 0.85, r: 0.60, color: 'rgba(237,230,212,0.18)', sx: 0.00012, sy: -0.00020 }, // cream wash
      { x: 0.30, y: 0.75, r: 0.45, color: 'rgba(255,142,106,0.32)', sx: -0.00016, sy: -0.00010 },// coral-light
      { x: 0.90, y: 0.85, r: 0.45, color: 'rgba(193,62,38,0.28)',   sx: 0.00020, sy: -0.00014 }  // coral-deep
    ];
