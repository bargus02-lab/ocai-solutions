...
(function () {
  ...
  function initAurora() {
    ...
    var blobs = [
      { x: 0.18, y: 0.20, r: 0.55, color: 'rgba(245,158,11,0.55)', sx: 0.00018, sy: 0.00013 },
      { x: 0.80, y: 0.30, r: 0.50, color: 'rgba(249,115,22,0.45)', sx: -0.00022, sy: 0.00018 },
      { x: 0.55, y: 0.85, r: 0.60, color: 'rgba(251,191,36,0.35)', sx: 0.00012, sy: -0.00020 },
      { x: 0.30, y: 0.75, r: 0.45, color: 'rgba(168,85,247,0.22)', sx: -0.00016, sy: -0.00010 },
      { x: 0.90, y: 0.85, r: 0.45, color: 'rgba(6,182,212,0.18)', sx: 0.00020, sy: -0.00014 }
    ];
